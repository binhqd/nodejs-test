BackendCtrls.controller('UploadImagesCtrl', function($scope, $http, $timeout) {
            ...
            (function($, $scope) {
                ...
                $('#fileupload').bind(
                    ...
                    function(e, data) {
                        ...
                        var input = $("<input ref=\'" + data.result.files[0].deleteUrl + "\' type=\'hidden\' class='uploadedImage' name=\'images[]\' value=\'"
